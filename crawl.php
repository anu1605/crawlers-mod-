...
$epapers = array("SAN" => "Sandesh,guj", "RP" => "Rajisthan Patrika,hin", "LS" => "Loksatta,mar", "NT" => "Namaste Telengana,tel", "PRM" => "Premeya,ori", "SAK" => "Sakshi,tel", "TET" => "Telangana Today,tel", "TT" => "The Telegraph,eng", "HT" => "Hindustan Times,eng", "LT" => "Live Hindustan,hin", "GSM" => "Gujarat Samachar,guj", "NVR" => "Navrasthra,mar", "NHT" => "Nav Hind Times,eng", "OHO" => "O Heral O,eng", "BS" => "Bombay Samachar,guj", "AU" => "Amar Ujala,hin",  "DJ" => "Danik Jagran,hin", "LM" => "Lokmat,mar", "MC" => "Mumbai Chaufer,mar", "NB" => "Navbharat,hin", "NBT" => "Navbharat Times,hin", "ND" => "Nai Dunia,hin", "RS" => "Rashtriya Sahara,hin", "YB" => "yashobhumi,hin", "PN" => "Punayanagri,mar", "TOI" => "Times of India,eng", "ET" => "Economic Times,eng", "MT" => "Maharashtra Times,eng", "Mirror" => "Mirror,eng", "DN" => "Dainik Navjyoti,hin", "DST" => "Dainik Savera times,hin", "NGS" => "Nav Gujarat Samay,guj", "PBK" => "Prabhat Khabar,hin", "HB" => "Hari Bhumi,hin", "HTV" => "Hitavada,eng");
