...
foreach ($epapers as $epapercode => $epaperArray) {
    ...
    if ($epapercode == "EiSamay" or $epapercode == "TOI" or $epapercode == "ET" or $epapercode == "MT" or $epapercode == "Mirror") {
